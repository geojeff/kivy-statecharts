    ...
    class RootState(State):
        ...
        class PongGame(State):
            ...
            def __init__(self, **kwargs):
                ...
                super(AppStatechart.RootState.PongGame, self).__init__(**kwargs)
            ...
            class InitializingGame(State):
                def __init__(self, **kwargs):
                    ...
                    super(AppStatechart.RootState.PongGame.InitializingGame, self).__init__(**kwargs)
                ...
                class ShowingGame(State):
                    def __init__(self, **kwargs):
                        super(AppStatechart.RootState.PongGame.InitializingGame.ShowingGame, self).__init__(**kwargs)
