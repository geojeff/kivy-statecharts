...
class ShowingTree(State):
    ...
    def __init__(self, **kwargs):
        super(ShowingTree, self).__init__(**kwargs)
    ...
    class ShowingNodeQuestion(State):
        ...
        def __init__(self, **kwargs):
            super(ShowingTree.ShowingNodeQuestion, self).__init__(**kwargs)
    ...
    class ShowingNodeAlreadyCompletedPopup(State):
        ...
        def __init__(self, **kwargs):
            super(ShowingTree.ShowingNodeAlreadyCompletedPopup, self).__init__(**kwargs)
    ...
    class ShowingIneligibleNodePopup(State):
        ...
        def __init__(self, **kwargs):
            super(ShowingTree.ShowingIneligibleNodePopup, self).__init__(**kwargs)
    ...
    class ShowingWrongAnswerPopup(State):
        ...
        def __init__(self, **kwargs):
            super(ShowingTree.ShowingWrongAnswerPopup, self).__init__(**kwargs)
...
class AppStatechart(StatechartManager):
    ...
    class RootState(State):
        ...
        class ShowingMain(State):
            ...
            # ShowingTreeOne
            #
            class ShowingTreeOne(ShowingTree):
                def __init__(self, **kwargs):
            ...
            # ShowingTreeTwo
            #
            class ShowingTreeTwo(ShowingTree):
                def __init__(self, **kwargs):
